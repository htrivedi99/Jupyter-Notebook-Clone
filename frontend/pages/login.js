...
function Login(){
    ...
    const login = async() => {
        ...
        if(form_error === false){
            setSpinner(true);
            const res = await axios.post("http://0.0.0.0:8000/login", userInfo);
    ...
    return (
        <div className="flex flex-col sm:flex-row w-full h-screen">
            ...
            <div className="bg-gray-200 w-full sm:w-2/3 flex justify-center items-center h-screen">
                <div className="bg-slate-400 w-3/4 lg:w-2/4 px-5 py-10 mt-10 mb-10 md:mt-16 md:mb-16 rounded-md">
                    ...
                    <div className="text-white text-sm md:text-base mt-10 flex justify-center items-center">
                        ...
                        <a className="no-underline text-blue-600 ml-1" href="/signup">
                            Sign Up
                        </a>
                </div>
